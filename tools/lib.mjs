...
export const OVERLAY_COMPS = ['hook-title', 'checklist-card', 'cta-card', 'lower-third', 'subtitle-track'];
...
export const RE = {
  ...
  timelineFile: (videoId, locale) => new RegExp(`^${videoId}_${locale}_v\\d{3}\\.kdenlive$`),
