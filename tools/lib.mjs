...
export const OVERLAY_COMPS = ['hook-title', 'checklist-card', 'cta-card', 'lower-third', 'subtitle-track', 'stage-cards', 'stage-cards-wide', 'phone-language', 'phone-embed', 'phone-sponsor', 'brand-title', 'brand-drop', 'profile-card', 'invite-card', 'kinetic-captions', 'feature-phones', 'feature-fan', 'side-screen', 'photo-reveal'];
