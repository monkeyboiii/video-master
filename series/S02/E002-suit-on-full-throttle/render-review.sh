#!/usr/bin/env bash
# Deterministic review render for S02E002.
# Run from anywhere:
#   bash video-master/series/S02/E002-suit-on-full-throttle/render-review.sh
#
...
MEDIA_DIR="$VIDEO_MASTER_ROOT/media/S02E002"
