# Edit Notes — S01E005 "verified-boost-rider" · en-US

Rough cut assembled programmatically via `kdenlive-build.repl`
→ `media/S01E005/verified-boost-rider.kdenlive`, then made Kdenlive-native with
...
```bash
# from the repo root
node series/S01/E005-verified-boost-rider/caption-map.mjs --test
node series/S01/E005-verified-boost-rider/caption-map.mjs
# from inside media/S01E005/   (footage-process.sh runs speech-check.py first)
bash ../../series/S01/E005-verified-boost-rider/footage-process.sh
bash ../../series/S01/E005-verified-boost-rider/screen-chop.sh
...
`media/S01E005/exports/DBX-APP-S01E005_en-US_tiktok_9x16_v001_review.mp4` — 65.49s.
...
SFX, music, and every overlay — with exactly ONE substitution: the caption clip on **V4-Captions**
is the Chinese (bilingual EN+ZH) render `DBX-APP-S01E005_zh-CN_9x16_kinetic-captions_v001.mov`
...
tracked in `public/fonts`) then assembles `DBX-APP-S01E005_zh-CN_v001.kdenlive` from
...
Deferred (out of scope this round): re-rendering `feature-fan` in Chinese
(`feature-fan.zh-CN.json` already exists) and the two-language "split" subtitle presentation. Open
translation-term calls (hashtags Latin vs translated; 骑手 vs 车友 for "rider") remain the user's to
rule on before a full-localization pass.
