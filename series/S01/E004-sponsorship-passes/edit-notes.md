# Edit Notes — S01E004 "sponsorship-passes" · en-US

Rough cut assembled programmatically via `kdenlive-build.repl`
→ `media/S01E004/sponsorship-passes.kdenlive`, then made Kdenlive-native with
...
```bash
# from the repo root
node series/S01/E004-sponsorship-passes/caption-map.mjs
# from inside media/S01E004/   (footage-process.sh runs speech-check.py first)
bash ../../series/S01/E004-sponsorship-passes/footage-process.sh
bash ../../series/S01/E004-sponsorship-passes/screen-chop.sh
...
`media/S01E004/exports/DBX-APP-S01E004_en-US_tiktok_9x16_v001_review.mp4`
