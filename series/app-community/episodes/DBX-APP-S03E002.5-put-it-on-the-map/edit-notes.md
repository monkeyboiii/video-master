...
Filed as **DBX-APP-S03E002.5**. The ID format had no fractional form, so one was added:
...
character), and `docs/naming-conventions.md` documents the interstitial rule. E003 keeps
