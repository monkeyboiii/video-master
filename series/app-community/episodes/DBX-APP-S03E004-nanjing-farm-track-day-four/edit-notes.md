...
at `media/DBX-APP-S03E004/voiceover/` and `media/audio/`, both git-ignored.
...
This is the episode that makes `docs/localization.md` earn its keep. The zh-CN read is built
