...
- The "golden-rule document" referenced here did not exist in the repo at scaffold time (the file thought to hold it was a duplicate of the background doc); `docs/golden-rules.md` was first reconstructed from the principles cited in this plan. The real source document (`FRAMEWORK.md`) was supplied afterwards and **merged into `docs/golden-rules.md`** as the single source of truth (2026-07-05); the original is preserved verbatim at `docs/archive/FRAMEWORK.md`.
